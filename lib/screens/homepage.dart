      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
              icon: Icon(Icons.lightbulb_outline_sharp), label: ''),
                          ...
                          Row(
                            children: [
                              ...
                              Icon(
                                ...
                                size: 32,
                                color: (_initialSliderVal == 0)
                                    ? greycolor
                                    : Colors.yellow
                                        .withAlpha(_initialSliderVal.toInt()),
                              ),
                            ],
                          ),
                          sbh10,
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(boxShadow: [
                  BoxShadow(
                      color: greycolor, offset: Offset(2, 7), blurRadius: 10)
